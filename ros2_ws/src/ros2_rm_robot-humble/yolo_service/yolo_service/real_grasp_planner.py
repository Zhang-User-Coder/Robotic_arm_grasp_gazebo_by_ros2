...
class YoloGraspPlanner(Node):
    def __init__(self):
        super().__init__('real_grasp_planner')
    ...
    def depth_callback(self,msg):
        try:
            cv_depth = self.bridge.imgmsg_to_cv2(msg,"uncoded")
            if msg.encoding == "16UC1":    #毫米改成米
                self.latest_depth_img = cv_depth.astype(np.float32) / 1000.0
            elif msg.endoding == "32FC1":
